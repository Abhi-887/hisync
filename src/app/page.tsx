...
import { Building2, Target, CheckCircle, ArrowRight, Search, BarChart3, Zap, Users, Award, TrendingUp, Settings, Database, Cpu, Play, Eye, Star, Clock, Shield, Lightbulb, MousePointer, Rocket, Globe } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 px-4 overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40">
      ...
      <section id="assessment" className="relative py-24 px-4 bg-gradient-to-br from-slate-50 via-slate-100/50 to-gray-50 overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
          {/* Gradient Orbs */}
